//the some chat functionality for All-Chat is utilized here for e.ge message send, file share and such
...
class ChatVC: UIViewController,UITextFieldDelegate,UIDocumentPickerDelegate {

    @IBOutlet var bottomConst: NSLayoutConstraint!
    @IBOutlet var txtMsg: UITextField!
    @IBOutlet var tblChat: UITableView!
    @IBOutlet weak var fileShare: UIButton!
    ...
    override func viewDidLoad() {
        ...
        //sets the background colour based on dark/light mode
    ...
    // this function receives all of the messages from the database (as a database) to be viewed by the user
...
//button which allows for messages to be sent. this function allows for the messages to be parsed as a dictionary as the user clicks
// send and to be sent as a string of text to the tableview
    ...
    //button which allows for a file to be shared within the chat's table view
    @IBAction func fileShareButton(_ sender: UIButton) {
    ...
    //the picker calls on the user's directory to view and browse through files
    ...
    //this is to allow the selected file to be shared to the chat's table view
    ...
    //updates the table view to show user's received and sent chats
    ...
    //keyboard will show upon text field click and fit to the specified device size
...
//specification of the chat app's tableview.
//Storing and retrieving the messages from the sender (the user) and messages to the user
